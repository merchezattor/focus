...
import { getApiToken, generateApiToken } from "@/app/actions"
...
function SettingsAccount({ user }: { user?: { name: string; email: string; image?: string | null; id: string } }) {
        ...
        <div className="space-y-6 max-w-2xl">
            <div>
                ...
                <div className="flex gap-4">
                    <Button variant="secondary" onClick={copyToClipboard} disabled={!token}>
                        Copy API token
                    </Button>
                    <Button variant="outline" onClick={handleGenerate} disabled={loading} className="text-destructive hover:text-destructive border-destructive/50 hover:bg-destructive/10">
