...
export function EditTaskDialog({ task, projects, onTaskUpdated, trigger, open: controlledOpen, onOpenChange }: EditTaskDialogProps) {
  ...
  const [optimisticComments, setOptimisticComments] = useState<Comment[]>(task.comments || []);
  ...
  const saveChanges = async (updates: {
    ...
    try {
      const payload = {
        ...
        projectId: updates.projectId !== undefined ? updates.projectId : (projectId || null),
        dueDate: updates.dueDate !== undefined ? updates.dueDate : (dueDate ? dueDate.toISOString() : null),
        planDate: updates.planDate !== undefined ? updates.planDate : (planDate ? planDate.toISOString() : null),
        ...
        <div className="flex flex-1 h-full overflow-hidden">
          ...
          <div className="flex-1 flex flex-col p-6 border-r overflow-y-auto">
            ...
            <div className="mt-8">
              <h3 className="text-sm font-medium mb-4 flex items-center gap-2 text-muted-foreground">
                Comments {optimisticComments.length ? `(${optimisticComments.length})` : ''}
              </h3>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem className="text-destructive focus:text-destructive" onClick={() => handleDeleteComment(comment.id)}>
              ...
              <div className="flex gap-2">
                ...
                <div className="flex-1 border rounded-lg p-2 focus-within:ring-1 focus-within:ring-ring">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" variant="ghost" onClick={() => setComment('')}>Cancel</Button>
          ...
          <div className="w-[300px] bg-muted/10 p-4 space-y-6 overflow-y-auto">
            <div className="space-y-4">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(date) => {
                        setDueDate(date);
                        saveChanges({ dueDate: date ? date.toISOString() : null });
                      }}
                      initialFocus
                    />
                  </PopoverContent>
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Plan Date</label>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="ghost"
                  ...
                  <PopoverContent className="w-auto p-0 z-[100]" align="start">
                    <Calendar
                      ...
                      onSelect={(date) => {
                        setPlanDate(date);
                        saveChanges({ planDate: date ? date.toISOString() : null });
                      }}
                      initialFocus
                    />
                  </PopoverContent>
